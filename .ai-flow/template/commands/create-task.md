...
- @.ai-flow/plan.md - Architecture, patterns, completed work
- @.ai-flow/learnings.md - Critical lessons from past implementations
- @.ai-flow/tasks/ - Previous task specs for pattern reference

### Your Job
Create a detailed implementation spec for the next unfinished task that enables a less-skilled AI to produce senior-level code without additional guidance.
