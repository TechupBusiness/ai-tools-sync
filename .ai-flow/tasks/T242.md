...
- [ ] Include all 10 supported package ecosystems from condition-evaluator.ts
- [ ] Provide working `when:` condition examples for each language
- [ ] Include both npm and Docker options for every language
- [ ] Add CI/CD examples for common platforms
...
- [ ] Covers Node.js/TypeScript installation options
- [ ] Covers Python with pip dependency examples
- [ ] Covers PHP with Composer dependency examples
- [ ] Covers Go with go.mod dependency examples
- [ ] Covers Rust with Cargo.toml dependency examples
- [ ] Covers Ruby with Gemfile dependency examples
- [ ] Covers Java/Kotlin with Maven/Gradle examples
- [ ] Covers .NET with NuGet dependency examples
- [ ] Covers Dart/Flutter with pubspec.yaml examples
- [ ] Includes Docker usage section
- [ ] Includes CI/CD integration examples
- [ ] Includes troubleshooting section
- [ ] All `when:` condition examples match actual namespace syntax
- [ ] plan.md updated to mark T242 as complete
