...
> **Status**: Needs rework — Claude skills require a dedicated content type before the policies rename proceeds
...
## Rework note
- Claude skills are more complex than initially scoped; add a dedicated Claude skill content type before (or alongside) the policies rename.
- Policies rename can follow once the Claude skill content type is defined.
