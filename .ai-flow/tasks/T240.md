...
- [ ] Use existing markdown formatting style from README.md
- [ ] Keep code examples concise and copy-pasteable
- [ ] Reference actual source files when describing features
...
- [ ] README.md includes `ai-sync clean` command documentation
- [ ] README.md includes `ai-sync status` command documentation
- [ ] README.md includes `ai-sync plugins` subcommands documentation
- [ ] README.md documents `@include` syntax for rule composition
- [ ] README.md documents `extends:` persona inheritance
- [ ] README.md documents platform-conditional blocks (`{{#claude}}...{{/claude}}`)
- [ ] README.md documents `when:` conditional rules with all namespaces
- [ ] README.md has updated badges (including downloads, tests)
- [ ] All code examples are syntactically valid
- [ ] No references to unimplemented features (T229 template variables)
- [ ] plan.md updated to mark T240 as complete
